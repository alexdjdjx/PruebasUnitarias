 ...
 * @author alumno
 */
public class EntornosOperaciones {

    private java.util.ArrayList<Integer> numeros; // referencia a la lista
     ...
     */
    public EntornosOperaciones(int[] datos) {
        if (datos == null || datos.length == 0) { // Verificamos que la
    ...
    public int getIndiceDe(int numero) throws
        ...
        throw new java.util.NoSuchElementException(String.valueOf(numero)); // El número no
